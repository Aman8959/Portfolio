    ...
    <section className="hero">
      ...
      <div className="hero-content page-shell">
        <div className="hero-copy">
          <p className="eyebrow"><span />AI/ML <b>•</b> Full-Stack <b>•</b> Software Development</p>
        ...
        <div aria-hidden="true" className="system-panel">
          <div className="panel-top"><span className="status-dot" />SYSTEM / AMAN.DEV <span>01</span></div>
          <div className="system-diagram">
            <div className="node node-main">Build<div>software</div></div>
            <div className="node node-ai">AI<div>models</div></div>
            <div className="node node-web">web<div>systems</div></div>
